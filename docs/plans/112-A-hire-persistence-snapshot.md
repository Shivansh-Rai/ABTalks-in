> **Snapshot, not the live board.** This is the hire-persistence copy of 112-A
> as it existed on `feat/talent-request-persistence` (`c2acf158`, 2026-09-05).
> The file `112-A-daily-task-board.md` is the current `upstream/master` board
> (Sohail, `b407cdad`). Both are kept because they are independent documents
> with different T-IDs; neither is discarded.
