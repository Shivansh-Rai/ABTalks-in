...
|----------|----------|------------|
| Legal entity | **ABTalksOnAI**, Sole Proprietorship (Proprietary), proprietor **Divya Shukla**. Micro enterprise, major activity Services, NIC 62099. Udyam **UDYAM-UP-29-0250625** (registered 01 Aug 2026; incorporation 25 Jul 2026). Address: Crossing Republic, Ghaziabad, Uttar Pradesh 201016, India | Closes the v1 "TBD" and v2 `<<FILL>>` rows; expanded from full Udyam certificate 2026-08-10 |
