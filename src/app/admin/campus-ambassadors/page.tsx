            ...
            <Card key={candidate.userId}>
              <CardHeader>
                <div className="flex items-start justify-between gap-2">
                  ...
                  <span className="shrink-0 inline-flex items-center gap-1 rounded-none bg-violet-500/10 text-violet-600 dark:text-violet-400 px-2 py-0.5 text-xs font-medium">
                    {candidate.domain}
                  </span>
                </div>
              </CardHeader>
