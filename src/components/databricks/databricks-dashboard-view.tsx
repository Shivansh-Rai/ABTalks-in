...
import { DatabricksStatsPanel } from "@/components/databricks/databricks-stats-panel";
...
export function DatabricksDashboardView({ data }: Props) {
      ...
      <div className="mx-auto w-full max-w-[1500px] space-y-8">
        ...
        <div className="rounded-[12px] border border-[#E0E0E0] bg-white shadow-[0_2px_8px_rgba(0,0,0,0.06)]">
          <button
            ...
            aria-controls="databricks-view-stats"
          ...
          {statsOpen && (
            <div
              id="databricks-view-stats"
              className="border-t border-[#E0E0E0] px-6 py-6"
            >
              <DatabricksStatsPanel data={data} />
            </div>
          )}
        </div>
        ...
        <div className="rounded-[12px] border border-[#E0E0E0] bg-white shadow-[0_2px_8px_rgba(0,0,0,0.06)]">
          <button
            ...
            aria-controls="databricks-mock-interview"
...
function progressLines(data: DatabricksDashboard): string[] {
...
function ContinueCard({ data }: { data: DatabricksDashboard }) {
  ...
  return (
    <div className="rounded-2xl border border-[#E0E0E0] bg-white p-8 shadow-[0_2px_8px_rgba(0,0,0,0.06)]">
      <div className="flex flex-col gap-6 sm:flex-row sm:items-end sm:justify-between">
        ...
        {cta && currentDay && (
          <Link
            href={`/program/databricks/day/${currentDay.dayNumber}`}
            className={ctaClass}
          >
            {cta}
          </Link>
