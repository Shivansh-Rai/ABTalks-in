...
const PLACE_STYLES = {
  1: {
    avatar:
      "size-16 border-[3px] border-[#AA821D] bg-[#03535F] text-lg shadow-[0_0_22px_rgba(170, 130, 29, 0.45)] sm:size-[4.5rem]",
    badge: "size-7 bg-[#AA821D] text-black",
    card: "min-h-[14rem] border-[#AA821D]/40 bg-gradient-to-b from-[#AA821D]/55 via-[#AA821D]/25 to-[#AA821D]/80 shadow-[0_12px_36px_rgba(170, 130, 29, 0.22)] sm:min-h-[16rem] lg:min-h-0 lg:flex-1",
    score: "text-2xl font-extrabold text-[#FFEDB0] sm:text-3xl",
    name: "text-sm font-bold sm:text-base",
    emptyCard:
      "border-dashed border-[#AA821D]/25 bg-gradient-to-b from-[#AA821D]/15 via-[#AA821D]/5 to-transparent",
  },
  2: {
    avatar:
      "size-14 border-[3px] border-[#D2D2D2] bg-[#03535F] text-base sm:size-16",
    badge: "size-6 bg-[#E0E0E0] text-[#353535]",
    card: "min-h-[11rem] border-[#D2D2D2]/35 bg-gradient-to-b from-[#D2D2D2]/45 via-[#626262]/20 to-[#000000]/85 sm:min-h-[12.5rem] lg:min-h-0 lg:flex-[0.78]",
    score: "text-xl font-bold text-[#E9E9E9] sm:text-2xl",
    name: "text-xs font-semibold sm:text-sm",
    emptyCard:
      "border-dashed border-[#A5A5A5]/25 bg-gradient-to-b from-[#A5A5A5]/15 via-[#626262]/5 to-transparent",
  },
  3: {
    avatar:
      "size-14 border-[3px] border-[#076573] bg-[#03535F] text-base sm:size-16",
    badge: "size-6 bg-[#076573] text-black",
    card: "min-h-[9rem] border-[#076573]/40 bg-gradient-to-b from-[#076573]/50 via-[#02434D]/20 to-[#02434D]/85 sm:min-h-[10.5rem] lg:min-h-0 lg:flex-[0.62]",
    score: "text-xl font-bold text-[#E7F2F3] sm:text-2xl",
    name: "text-xs font-semibold sm:text-sm",
    emptyCard:
      "border-dashed border-[#076573]/25 bg-gradient-to-b from-[#076573]/15 via-[#03535F]/5 to-transparent",
  },
} as const;
      ...
      <div className={cn("relative shrink-0", isFirst ? "mb-3" : "mb-2.5")}>
        ...
        <div
          className={cn(
            ...
            styles.avatar,
            !filled &&
              "border-dashed border-white/20 bg-[#353535] text-[#787878] shadow-none",
          )}
        >
...
export function ProgramLeaderboardView({
  ...
  return (
    <div className="-mx-4 -my-6 flex h-[calc(100svh-3.5rem)] flex-col overflow-hidden bg-[#000000] px-6 py-6 text-white sm:px-8 md:px-10 lg:px-12">
      ...
      <div className="flex min-h-0 flex-1 flex-col gap-5 overflow-hidden lg:flex-row lg:gap-8">
        ...
        <aside className="flex w-full shrink-0 flex-col overflow-hidden lg:h-full lg:w-[40%] lg:max-w-[40%]">
          <p className="mb-3 shrink-0 text-xs font-semibold tracking-wide text-[#787878] uppercase">
            Top 3
          </p>
          <div className="relative flex min-h-[22rem] flex-1 flex-col overflow-hidden rounded-2xl border border-[#03535F]/35 bg-[radial-gradient(ellipse_80%_60%_at_50%_0%,rgba(3, 83, 95, 0.18),transparent_55%),linear-gradient(180deg,rgba(0, 0, 0, 0.95)_0%,rgba(0, 0, 0, 0.98)_100%)] p-4 shadow-[inset_0_1px_0_rgba(255,255,255,0.04)] sm:min-h-[26rem] sm:p-6 lg:min-h-0">
            <div
              className="pointer-events-none absolute inset-x-8 top-0 h-px bg-gradient-to-r from-transparent via-[#E7F2F3]/50 to-transparent"
              aria-hidden
            />
        ...
        <section className="flex min-h-0 min-w-0 flex-1 flex-col overflow-hidden lg:w-[60%]">
          ...
          <div className="min-h-0 flex-1 overflow-y-auto overflow-x-auto rounded-2xl border border-[#02434D] bg-[#000000]/80">
            {rows.length === 0 ? (
              <p className="px-6 py-12 text-center text-sm text-[#A5A5A5]">
              ...
              <>
                <table className="w-full min-w-[560px] text-left text-sm">
                  <thead className="sticky top-0 z-10 bg-[#000000]">
                    <tr className="border-b border-[#02434D] text-xs font-semibold tracking-wide text-[#787878] uppercase">
                  ...
                  <tbody>
                    {rest.map((row) => (
                      <tr
                        key={row.memberId}
                        className={cn(
                          "border-b border-[#02434D]/80 last:border-0",
                          row.isViewer && "bg-[#03535F]/10",
                        )}
                      >
                        ...
                        <td className="px-4 py-3 text-[#E7F2F3]">
                          {row.company ?? "—"}
                        </td>
                        <td className="px-4 py-3 text-[#E7F2F3]">
                          {row.jobRole ?? "—"}
                        ...
                        <td className="px-4 py-3 text-center text-[#A5A5A5]">
                ...
                {rest.length === 0 && (
                  <p className="px-4 py-8 text-center text-xs text-[#A5A5A5]">
