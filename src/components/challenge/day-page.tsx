      ...
      <main className="container mx-auto max-w-3xl space-y-6 px-4 py-6 md:px-6 md:py-8">
        ...
        >
          ...
          <div className="flex flex-wrap items-center gap-2 pt-2">
            <span className="inline-flex items-center gap-1.5 rounded-none bg-blue-500/10 px-2.5 py-0.5 text-xs font-semibold text-blue-600 dark:text-blue-400">
              ...
              <ol className="space-y-2">
                {content.tool.setupSteps.map((step, i) => (
                  <li key={i} className="flex items-start gap-3">
                    <div className="flex h-5 w-5 shrink-0 items-center justify-center rounded-none bg-orange-500/10 text-[10px] font-bold text-orange-600 dark:text-orange-400">
                      {i + 1}
                    </div>
        ...
        >
          <ol className="space-y-3">
            {content.task.steps.map((step, i) => (
              <li key={i} className="flex items-start gap-3">
                <div className="flex h-7 w-7 shrink-0 items-center justify-center rounded-none bg-emerald-500/10 text-sm font-bold text-emerald-600 dark:text-emerald-400">
                  {i + 1}
                </div>
        ...
        >
          ...
          <ol className="space-y-2.5">
            {content.learning.bullets.map((bullet, i) => (
              <li key={i} className="flex items-start gap-3">
                <div className="flex h-6 w-6 shrink-0 items-center justify-center rounded-none bg-amber-500/10 text-xs font-bold text-amber-600 dark:text-amber-400">
                  {i + 1}
                </div>
        ...
        >
          ...
          <div className="mb-3 inline-flex items-center gap-2 rounded-none bg-pink-500/10 px-3 py-1 font-mono text-xs font-semibold text-pink-600 dark:text-pink-400">
