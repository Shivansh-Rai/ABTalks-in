...
export function FaqSection() {
  ...
  return (
    <section id="faq" className={cn(HUB_SECTION_CLASS, "py-12")}>
      <div className={HUB_CONTAINER_CLASS}>
        <div className="grid gap-8 lg:grid-cols-[2fr_3fr] lg:items-center lg:gap-12">
          {/* Left column: heading + subtitle. Centred against the accordion
              rather than stuck to its top — it used to be `lg:sticky lg:top-24
              lg:self-start`, which pinned it to the top of the column. */}
          <div>
