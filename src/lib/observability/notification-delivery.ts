 ...
 *
 * Every outbound message records one `OutboundDelivery` row, one structured
...
import type { OutboundDeliveryStatus } from "@prisma/client";
...
export async function recordDelivery(
  ...
  await persist({
    ...
    status: outcome.status as OutboundDeliveryStatus,
