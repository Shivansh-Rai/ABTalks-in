...
You must be at least **18 years old** and able to form a binding contract. The Service is intended for students, recent graduates, and working professionals. If you register on behalf of an organization, you represent that you have authority to bind that organization.

## 2. Accounts

- In production you sign in with **Google OAuth**. Keep your Google account secure.  
- One person, one account. Do not share credentials or impersonate others.  
- You are responsible for activity under your account.  
- We may suspend or terminate accounts that violate these Terms or Community Rules.

## 3. Tracks and features
...
- Cheat, falsify proof-of-work, or submit content you do not have rights to share  
- Harass, spam, scrape, or disrupt the Service  
- Attempt unauthorized access to other users’ data or admin systems  
- Use the Service for unlawful purposes  

Community conduct rules shown in onboarding apply in addition to these Terms.
...
Eligible completions may receive certificates. Certificate IDs and recipient names may be **publicly verifiable** at `/verify/[certificateId]`. We may revoke certificates for fraud or Terms violations.

Certificates issued by ABTalks are certificates of **participation and completion only**. They are **not** accredited academic or professional qualifications, confer no academic credit, and are not recognised, approved, or accredited by any university, statutory body, examination authority, or regulator in India or elsewhere. Do not represent them as a degree, diploma, or licensed credential.
...
Redemptions may require a shipping address and phone for fulfillment. Physical goods availability and shipping timelines are not guaranteed. Fraudulent redemptions may be cancelled.

**Synergy Points are not money.** They are a promotional loyalty balance earned through participation. They are **not currency, not a payment instrument, not a security, and carry no cash value**. They cannot be purchased, sold, transferred, exchanged for cash, or redeemed outside the Service. We may adjust, expire, reverse, or revoke points to correct errors or to address abuse or Terms violations, and we may change item pricing or withdraw items at any time.

Fulfillment of physical rewards is **discretionary and currently limited to addresses in India**. If we cannot fulfill a redemption, our sole obligation is to restore the redeemed points to your balance.
...
ABTalks branding, challenge content, curricula, and platform software are owned by ABTalks or its licensors. You may not copy or redistribute them except as allowed by the Service.
...
TO THE MAXIMUM EXTENT PERMITTED BY LAW, ABTALKS AND ITS OPERATORS WILL NOT BE LIABLE FOR INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL, OR PUNITIVE DAMAGES, OR ANY LOSS OF DATA, PROFITS, OR OPPORTUNITIES ARISING FROM YOUR USE OF THE SERVICE. OUR AGGREGATE LIABILITY FOR CLAIMS RELATING TO THE SERVICE IS LIMITED TO THE GREATER OF (A) AMOUNTS YOU PAID US FOR THE SERVICE IN THE 12 MONTHS BEFORE THE CLAIM OR (B) INR 5,000.
...
We may update these Terms. The version and effective date appear at the top. Material changes may require re-acceptance on next signup or significant action. Continued use after the effective date constitutes acceptance where permitted by law.

## 18. Grievance Officer and contact

For complaints about the Service, your content, or your data:
...
Other links: [/contact](/contact) · [Privacy Policy](/privacy) · [Cookie Policy](/cookies) · [Data rights requests](/privacy/requests)
